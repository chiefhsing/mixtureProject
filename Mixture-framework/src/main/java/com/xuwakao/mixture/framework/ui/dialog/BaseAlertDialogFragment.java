...
import com.xuwakao.mixture.framework.R;
import com.xuwakao.mixture.framework.utils.MLog;
import com.xuwakao.mixture.framework.utils.StringUtils;
...
public abstract class BaseAlertDialogFragment extends DialogFragment {
    ...
    public interface NoticeDialogCloseListener {
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (args != null) {
            dialog.setCanceledOnTouchOutside(args.getBoolean(BaseAlertDialogBuilder.CANCELABLE_TOUCH_OUTSIDE));
        }
    ...
    public static class ViewBuilder {
        ...
        private void setMessage() {
            if (!StringUtils.isEmptyOrNull(mMessageString)) {
                View viewMessage = mInflater.inflate(R.layout.dialog_message, mContentView, false);
        ...
        private void setTitleInfo() {
            if (!StringUtils.isEmptyOrNull(mTitleString)) {
                ...
                MLog.verbose("cadc", "closeIcon is " + mCloseIcon);
        ...
        public ViewBuilder setMessage(String message) {
