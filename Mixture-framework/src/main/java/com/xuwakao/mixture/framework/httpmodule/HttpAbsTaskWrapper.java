...
public abstract class HttpAbsTaskWrapper{
     ...
     *
     * Whether job is attempted to retry or not,it is based on the attribute {@link com.xuwakao.mixture.framework.httpmodule.HttpAbsRequestParam#retryCount}
     ...
     * But it's strongly recommended to subclass {@link com.xuwakao.mixture.framework.httpmodule.HttpBaseTask},but not this.
     *
     * @param e
     */
    @Deprecated
