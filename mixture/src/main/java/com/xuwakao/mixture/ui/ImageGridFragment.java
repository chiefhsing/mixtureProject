...
import com.xuwakao.mixture.BuildConfig;
...
//        ((ActionBarActivity)getActivity()).getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#00212121")) );
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.color_demo_menu, menu);
    }
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        @Override
        public int getCount() {
            return TestImage.imageThumbUrls.length;
        }

        @Override
        public Object getItem(int position) {
            return TestImage.imageThumbUrls[position];
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            param.url = TestImage.imageThumbUrls[position];
            MLog.verbose("AtomicInteger", "AtomicInteger getView is " + AppConfig.getView.incrementAndGet());
